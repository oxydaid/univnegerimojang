...
use App\Livewire\Landing\DonationPage;
...
use App\Livewire\Landing\ServerList;
...
Route::get('/server', ServerList::class)->name('servers.index');
Route::get('/donasi', DonationPage::class)->name('donations.index');
